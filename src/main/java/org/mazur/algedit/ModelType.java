...
public enum ModelType {
  ...
  /** Types. */
  ALGORITHM("alg"), GRAPH("grh"), TRANS_TABLE("ttl"), BOOL_FUNCTIONS("bfn"),
  DEVICE("dev");
  ...
  static {
    ...
    ModelType.BOOL_FUNCTIONS.setDescription("Boolean functions");
    ModelType.DEVICE.setDescription("Devices");
  }
